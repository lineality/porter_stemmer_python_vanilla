...
__all__ = ['PorterVanillaPyStemmer', 'stem_file_wrapper', 'run_comprehensive_tests']
...
class PorterVanillaPyStemmer:
    ...
    def stem_file_wrapper(
        ...
        The function uses the PorterVanillaPyStemmer.stem_file_lines() generator internally,
...
# import from module
from porter_module import PorterVanillaPyStemmer
